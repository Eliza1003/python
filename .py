...
#   person_name    <- "Enter your name:eliza "
#   goal_name      <- "Enter one skill you want to get better at:typing "
#   target_month   <- "Enter the month you want to reach it by:january "
