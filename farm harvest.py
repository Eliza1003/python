...
# Calculate the total and average havest
total  = field1 + field2 + field3 + field4 + field5
average = total / 5

print("Total havest   :", total, "kg")
print("Average per feild   :", average, "kg")

# Price per kg is 15 dollers - calculate total earnings
price_per_kg = 15
earnings = total * price_per_kg
print("Total earnings   : Rs.", earnings)

# --- Floor Divison (//) and module (%) ---
...
# Compare this year's havest with last year
last_year = 500
...
# subract15 kg saved as seeds for next season
total -= 15
